...
const float GEAR_RATIO = 50.0; // numbers from documentation. In real life need to correct it somehow
const float WHEEL_DIAMETER = 29.2; // numbers from documentation.

const float MOUSE_RADIUS = 35.0; // left turn R = 40.455; // reduce in case of pere-turn, increase in case of nedo-turn

const float SPEED_FF = 0.3; // tune to make average speed
const float ROTATION_BIAS = -0.0075; // to make robot go forward:  + to turn right, - to turn left

const int MOTOR_LEFT_POLARITY = 0; // 0 or 1
const int MOTOR_RIGHT_POLARITY = 0; // 0 or 1

const int ENCODER_LEFT_POLARITY = -1; // -1 or 1
const int ENCODER_RIGHT_POLARITY = 1; // -1 or 1
...
const float KP_ROT = 2.0;
const float KD_ROT = 0.0;

// controller constants for the steering controller
const float KP_STEER = 1.5;
...
const int LEFT_CALIBRATION = 210; // test when robot centered and no front wall
const int RIGHT_CALIBRATION = 135; // test when robot centered and no front wall
const int FRONT_CALIBRATION_LEFT = 100; // test when robot with back walls
...
const uint8_t RIGHT_WALL_SENSOR         = A3;
...
const uint8_t LEFT_DIR_1 = 7;
const uint8_t LEFT_DIR_2 = 8;
const uint8_t RIGHT_DIR_1 = 4;
const uint8_t RIGHT_DIR_2 = 5;
...
const uint8_t LED1 = 15;
const uint8_t LED2 = A2;
