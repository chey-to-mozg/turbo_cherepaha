...
const float FRONT_SCALE_LEFT = (float)NOMINAL_VALUE / FRONT_CALIBRATION_LEFT;
const float FRONT_SCALE_RIGHT = (float)NOMINAL_VALUE / FRONT_CALIBRATION_RIGHT;
...
// ** SENSORS ** //
const uint8_t LEFT_WALL_SENSOR          = A1;
const uint8_t RIGHT_WALL_SENSOR         = A0;
const uint8_t FRONT_LEFT_WALL_SENSOR    = A3;
const uint8_t FRONT_RIGHT_WALL_SENSOR   = A2;
